...
const ROADMAP_MODULES: RoadmapItem[] = [
  {
    ...
    badge: "Active",
    desc: "Active recall 199 istilah IT Jepang & Inggris, furigana kanji toggle, audio TTS, dan analogi visual Kitami-shiki.",
    target: "Pondasi Terminologi & Kosakata Ujian FE (199 Kartu / 20 Hari)",
    status: "active",
  },
  {
    id: "quiz",
