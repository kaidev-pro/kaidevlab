...
const projects = {
  ...
  "fe-study-hub": {
    ...
    summary: "A cognitive study gym for Japan’s Fundamental Information Technology Engineer Examination (基本情報技術者試験) featuring 159 high-yield flashcards with native furigana & TTS, 16-day structured plan, 45-question CBT simulator, pseudocode tracer, and offline PWA mode.",
    ...
    goals: ["Create an active recall drill with native Japanese TTS and furigana toggles", "Simulate the authentic CBT exam (15/30/45 question flexible sessions) with live scoring and digital certificates", "Build an interactive pseudocode tracer to demystify trace tables for 科目B (8 core algorithms)", "Deliver an installable offline PWA (電車モード) for studying inside commuter trains without signal"],
    features: ["159 High-Yield Flashcards (84 Technology, 21 Management, 24 Strategy, 30 Exam Vocabulary & Kanji)", "Active recall drill with Kitami-shiki visual analogies & differentiator keywords", "Native Kanji <ruby> furigana toggle and native Japanese Text-to-Speech audio pronunciation", "CBT Mock Exam simulator with 45 authentic IPA questions and flexible session options (15/30/45 questions)", "Automated scoring, category breakdown, and printable Digital Passing Certificate (合格証明書)", "Interactive Pseudocode Step-Tracer with real-time trace tables for 8 FE algorithms", "4 Interactive calculators (Availability, MTBF/MTTR, Effective Memory Access Time, BEP)", "PWA with Service Worker offline caching (電車モード) and install prompt"],
    ...
    limitations: ["Currently curated to 159 high-yield terminology cards and 45 past-exam questions", "Additional past exam question banks will be expanded iteratively"],
